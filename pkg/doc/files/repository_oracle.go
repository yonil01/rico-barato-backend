...
func (s *orcl) create(m *Files) error {
...
func (s *orcl) update(m *Files) error {
	date := time.Now()
	m.UpdatedAt = date
...
func (s *orcl) getByID(id int) (*Files, error) {
...
func (s *orcl) getAll() ([]*Files, error) {
	var ms []*Files
...
func (s *orcl) getFilesByEntityId(entityId int, typeEntity int) ([]*Files, error) {
