...
func (s *sqlserver) create(m *Food) error {
	var id int
	date := time.Now()
	m.UpdatedAt = date
	m.CreatedAt = date
...
func (s *sqlserver) update(m *Food) error {
	date := time.Now()
	m.UpdatedAt = date
...
func (s *sqlserver) getByID(id int) (*Food, error) {
...
func (s *sqlserver) getAll() ([]*Food, error) {
	var ms []*Food
...
func (s *sqlserver) getFoodsByEntityId(entityId int) ([]*Food, error) {
